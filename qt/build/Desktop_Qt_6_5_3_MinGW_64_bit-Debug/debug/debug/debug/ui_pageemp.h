/********************************************************************************
** Form generated from reading UI file 'pageemp.ui'
**
...
public:
    ...
    void setupUi(QDialog *pageemp)
    {
        if (pageemp->objectName().isEmpty())
            pageemp->setObjectName(QStringLiteral("pageemp"));
        pageemp->resize(1470, 1000);
        tabWidget = new QTabWidget(pageemp);
...
"font: 22pt \"Bebas Neue\";"));
        ...
        nomasc = new QPushButton(groupBox);
        nomasc->setObjectName(QStringLiteral("nomasc"));
        nomasc->setGeometry(QRect(1150, 70, 121, 28));
...
"padding: 5px;"));
        ...
        pushButton_3 = new QPushButton(pageemp);
        ...
        condpb = new QPushButton(pageemp);
        ...
        logoutpb = new QPushButton(pageemp);
        ...
        retranslateUi(pageemp);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(pageemp);
    } // setupUi

    void retranslateUi(QDialog *pageemp)
    {
        pageemp->setWindowTitle(QApplication::translate("pageemp", "Dialog", Q_NULLPTR));
        groupBox->setTitle(QString());
        cin_e->setPlaceholderText(QApplication::translate("pageemp", "Numbers only", Q_NULLPTR));
        label_4->setText(QApplication::translate("pageemp", "Role", Q_NULLPTR));
        label->setText(QApplication::translate("pageemp", "name", Q_NULLPTR));
        nom_e->setPlaceholderText(QApplication::translate("pageemp", "Characters only", Q_NULLPTR));
        label_2->setText(QApplication::translate("pageemp", "Cin", Q_NULLPTR));
        label_3->setText(QApplication::translate("pageemp", "firstname", Q_NULLPTR));
        prenom_e->setPlaceholderText(QApplication::translate("pageemp", "Characters only", Q_NULLPTR));
        label_6->setText(QApplication::translate("pageemp", "date of birth", Q_NULLPTR));
        daten_e->setPlaceholderText(QApplication::translate("pageemp", "YYYY-MM-DD", Q_NULLPTR));
        label_9->setText(QApplication::translate("pageemp", "Salary", Q_NULLPTR));
        salaire_e->setPlaceholderText(QApplication::translate("pageemp", "Number only", Q_NULLPTR));
        label_5->setText(QApplication::translate("pageemp", "hiring date", Q_NULLPTR));
        datee_e->setPlaceholderText(QApplication::translate("pageemp", "YYYY-MM-DD", Q_NULLPTR));
        role_e->clear();
        role_e->insertItems(0, QStringList()
         << QApplication::translate("pageemp", "Receptioniste", Q_NULLPTR)
         << QApplication::translate("pageemp", "Assistant", Q_NULLPTR)
         << QApplication::translate("pageemp", "Ressource Humaine", Q_NULLPTR)
        );
        label_21->setText(QApplication::translate("pageemp", "Phone", Q_NULLPTR));
        telephone_e->setPlaceholderText(QApplication::translate("pageemp", "+216", Q_NULLPTR));
        label_22->setText(QApplication::translate("pageemp", "Adresse", Q_NULLPTR));
        adresse_e->setPlaceholderText(QApplication::translate("pageemp", "Characters only", Q_NULLPTR));
        label_23->setText(QApplication::translate("pageemp", "Email", Q_NULLPTR));
        email_e->setPlaceholderText(QApplication::translate("pageemp", "email@gmail.com", Q_NULLPTR));
        radioButton->setText(QApplication::translate("pageemp", "nom", Q_NULLPTR));
        radioButton_2->setText(QApplication::translate("pageemp", "prenom", Q_NULLPTR));
        sortAscButton->setText(QApplication::translate("pageemp", "ASCendant", Q_NULLPTR));
        sortDescButton->setText(QApplication::translate("pageemp", "DESCendant", Q_NULLPTR));
        label_12->setText(QString());
        label_11->setText(QString());
        label_13->setText(QApplication::translate("pageemp", "Username", Q_NULLPTR));
        user_e->setPlaceholderText(QString());
        label_14->setText(QApplication::translate("pageemp", "Password", Q_NULLPTR));
        pb_pdf->setText(QApplication::translate("pageemp", "pdf", Q_NULLPTR));
        statrole->setText(QApplication::translate("pageemp", "Role", Q_NULLPTR));
        lab_chart_bar->setText(QString());
        label_17->setText(QApplication::translate("pageemp", "Task", Q_NULLPTR));
        task_e->clear();
        task_e->insertItems(0, QStringList()
         << QApplication::translate("pageemp", "Schedule appointments", Q_NULLPTR)
         << QApplication::translate("pageemp", "Manage correspondence", Q_NULLPTR)
         << QApplication::translate("pageemp", "Coordinate meetings", Q_NULLPTR)
         << QApplication::translate("pageemp", "Organize supplies", Q_NULLPTR)
         << QApplication::translate("pageemp", "Prepare reports ", Q_NULLPTR)
         << QApplication::translate("pageemp", "Handle phone calls ", Q_NULLPTR)
         << QApplication::translate("pageemp", "Support team ", Q_NULLPTR)
         << QApplication::translate("pageemp", "Update databases", Q_NULLPTR)
         << QApplication::translate("pageemp", "Manage mails", Q_NULLPTR)
        );
        pb_ajouter->setText(QString());
        pb_modifier_2->setText(QString());
        pb_supprimer->setText(QString());
        lineEdit->setText(QString());
        lineEdit->setPlaceholderText(QApplication::translate("pageemp", "Search", Q_NULLPTR));
        label_19->setText(QApplication::translate("pageemp", "export", Q_NULLPTR));
        refrech_pb->setText(QString());
        search->setText(QString());
        ord->setText(QApplication::translate("pageemp", "Original", Q_NULLPTR));
        radioButton_3->setText(QApplication::translate("pageemp", "cin", Q_NULLPTR));
        nomasc->setText(QApplication::translate("pageemp", "asc nom", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QString());
        label_10->setText(QString());
        pushButton_3->setText(QApplication::translate("pageemp", "  EMPLOYEE", Q_NULLPTR));
        condpb->setText(QApplication::translate("pageemp", "CONDIDAT", Q_NULLPTR));
...
namespace Ui {
    class pageemp: public Ui_pageemp {};
} // namespace Ui
