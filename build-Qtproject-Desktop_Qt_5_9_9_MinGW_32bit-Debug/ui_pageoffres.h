...
"}"));
        ...
        pushButton->setGeometry(QRect(432, 30, 161, 28));
...
"}"));
        ...
        pushButton_2->setGeometry(QRect(470, 160, 93, 28));
        lab_chart_pie->raise();
        label_12->raise();
        label_11->raise();
        label_2->raise();
...
"padding: 5px;"));
    ...
    void retranslateUi(QDialog *pageoffres)
    {
        ...
        pushButton->setText(QApplication::translate("pageoffres", "afficher tableau", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("pageoffres", "PushButton", Q_NULLPTR));
